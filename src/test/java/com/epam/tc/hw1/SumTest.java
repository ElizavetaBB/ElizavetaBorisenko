...
public class SumTest {
    ...
    @Test(groups = {"sum"},
            dataProviderClass = SumDataProvider.class, dataProvider = "correct long sum data")
    ...
    @Test(groups = {"sum"},
            dataProviderClass = SumDataProvider.class, dataProvider = "correct double sum data")
