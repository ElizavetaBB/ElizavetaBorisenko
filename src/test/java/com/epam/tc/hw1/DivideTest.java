...
public class DivideTest {
    ...
    @Test(dataProviderClass = DivideDataProvider.class, dataProvider = "correct long divide data")
    public void divideLongTest(long a, long b, long expected) {
        Calculator calculator = new Calculator();
        assertThat(calculator.div(a, b)).isEqualTo(expected);
    }

    @Test(dataProviderClass = DivideDataProvider.class, dataProvider = "correct double divide data")
    ...
    @Test(dataProviderClass = DivideDataProvider.class, dataProvider = "correct big double divide data")
    public void divideBigDoubleTest(double a, double b, double expected) {
        Calculator calculator = new Calculator();
        assertThat(calculator.div(a, b)).isEqualTo(expected, offset(1E-5));
    }

    @Test(dataProviderClass = DivideDataProvider.class, dataProvider = "divide by zero data")
